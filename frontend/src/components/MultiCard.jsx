  ...
  return (
    <div className="card-container">
      <div className="item1">
        ...
        <a href="https://www.ray-ban.com/usa/sunglasses/men-s">MEN</a>
        </div>
      ...
      <div className="item2">
      <div className='red-box'>
        <a href="https://www.ray-ban.com/usa/sunglasses/women-s">WOMEN</a>
      </div>
      ...
      <div className="item3">
      <div className='red-box'>
        <a href="https://www.ray-ban.com/usa/sunglasses/junior">KIDS</a>
      </div>
